...
export default function Footer() {
  ...
  return (
    <div className="bg-card m-4 hidden flex-col items-center justify-center rounded-xl md:flex">
      <div>
            ...
            <div className="flex flex-col items-center justify-center px-2">
              <div className="flex flex-col items-center py-5">
                <motion.div
                  ...
                  className="lg:to-card inline-block text-center text-2xl font-bold text-white sm:text-4xl md:text-5xl lg:bg-gradient-to-b lg:from-[#84878D] lg:via-[#84878D] lg:bg-clip-text lg:text-8xl lg:text-transparent"
                >
