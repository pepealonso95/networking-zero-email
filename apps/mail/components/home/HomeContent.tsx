  ...
  return (
    <main className="relative flex h-full flex-1 flex-col overflow-x-hidden bg-[#0F0F0F]">
      ...
      <div className="relative mt-52">
        ...
        >
          <div className="bg-card mx-auto inline-flex max-w-[600px] flex-col items-center justify-center overflow-hidden rounded-2xl shadow-md">
            ...
            <div className="inline-flex h-12 items-center justify-start gap-2.5 self-stretch p-4">
              <Clock className="relative h-3.5 w-3.5 overflow-hidden fill-current" />
            ...
            <div className="flex flex-col items-start justify-start gap-12 self-stretch rounded-2xl bg-card px-4 py-3">
              ...
              <div className="inline-flex items-center justify-between self-stretch">
                <div className="flex items-center justify-start gap-3">
                  ...
                  <div className="flex h-7 items-center justify-center gap-0.5 overflow-hidden rounded-md bg-muted px-1.5">
                    <Plus className="relative h-2.5 w-2.5 overflow-hidden fill-current" />
                ...
                <div className="hidden items-start justify-start gap-3 md:flex">
                  <div className="flex h-7 items-center justify-center gap-0.5 overflow-hidden rounded-md bg-muted px-1.5">
                    <Cube className="relative h-3 w-3 overflow-hidden fill-current" />
                  ...
                  <div className="flex h-7 items-center justify-center gap-0.5 overflow-hidden rounded-md bg-muted px-1.5">
                    <MediumStack className="relative mx-1 h-2.5 w-2.5 overflow-hidden fill-current" />
        ...
        <div className="mx-auto grid max-w-[1250px] gap-12 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <div className="relative h-96 w-full overflow-hidden rounded-2xl">
              <div className="absolute left-0 top-0 h-96 w-96 rounded-2xl border border bg-neutral-800" />
              <div className="outline-tokens-stroke-light/5 bg-card absolute left-[39px] top-[34px] inline-flex h-[771px] w-72 flex-col items-start justify-start overflow-hidden rounded-lg">
                <div className="inline-flex h-10 items-center justify-start gap-3 self-stretch overflow-hidden border-b-[0.38px] border px-4 py-5">
                  <div className="flex flex-1 items-center justify-start gap-2">
                    <div className="flex flex-1 items-center justify-start gap-1.5">
                      <PanelLeftOpen className="h-3 w-3 fill-muted-foreground dark:fill-white" />
                      <div className="ml-1 justify-start text-xs leading-3 text-white">Inbox</div>
                    </div>
                  </div>
                  <div className="flex items-center justify-start gap-1">
                    <Check className="h-2.5 w-2.5 fill-muted-foreground dark:fill-white" />
                  ...
                  <div className="flex items-center justify-start gap-2">
                    <Filter className="relative h-3 w-3 fill-muted-foreground dark:fill-white" />
                  </div>
                </div>
                <div className="flex flex-col items-start justify-start gap-3 self-stretch p-4">
                  <div className="inline-flex h-7 items-center justify-start gap-1 self-stretch overflow-hidden rounded bg-[#141414] pl-1.5 pr-[3.04px]">
                    <Search className="relative mr-1 h-3 w-3 overflow-hidden rounded-[1.14px] fill-muted-foreground dark:fill-white" />
                    <div className="flex-1 justify-start text-xs leading-3 text-muted-foreground">
                      Search
                    </div>
                    <div className="flex h-5 items-center justify-center gap-2 rounded-sm bg-muted px-1">
                  ...
                  <div className="inline-flex items-start justify-start gap-1.5 self-stretch">
                    <div className="flex h-6 w-6 items-center justify-center gap-[3.04px] overflow-hidden rounded bg-muted">
                      <Lightning className="relative h-3 w-3 overflow-hidden fill-muted-foreground dark:fill-white" />
                    </div>
                    <div className="flex h-6 w-6 items-center justify-center gap-[3.04px] overflow-hidden rounded bg-muted">
                      <ExclamationTriangle className="relative h-3.5 w-3.5 overflow-hidden fill-muted-foreground dark:fill-white" />
                    </div>
                    ...
                    <div className="flex h-6 w-6 items-center justify-center gap-[3.04px] overflow-hidden rounded bg-muted">
                      <Bell className="relative h-3 w-3 overflow-hidden fill-muted-foreground dark:fill-white" />
                    </div>
                    <div className="flex h-6 w-6 items-center justify-center gap-[3.04px] overflow-hidden rounded bg-muted">
                      <Tag className="relative h-3 w-3 overflow-hidden fill-muted-foreground dark:fill-white" />
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-start justify-start gap-1.5 self-stretch px-1.5">
                  ...
                  <div className="inline-flex items-center justify-start gap-2.5 self-stretch rounded-lg p-2.5">
                    <div className="inline-flex h-6 w-6 flex-col items-center justify-center gap-2 overflow-hidden rounded-full bg-muted px-1 py-2">
                      <GroupPeople className="relative h-5 w-5 overflow-hidden fill-muted-foreground dark:fill-white" />
                    </div>
          ...
          >
            <div className="relative h-96 w-96 overflow-hidden rounded-2xl">
              ...
              <div className="absolute left-[44px] top-0 h-[720px] w-[610px]">
                <div className="absolute left-[31px] top-[29px] inline-flex h-[720px] w-[547px] flex-col items-start justify-start overflow-hidden rounded-lg bg-card opacity-20">
                  <div className="border-tokens-stroke-light/5 inline-flex h-9 items-center justify-between self-stretch overflow-hidden border-b-[0.35px] py-3 pl-3.5 pr-2">
                    <div className="flex items-center justify-start gap-3">
                      <X className="relative h-3 w-3 overflow-hidden fill-muted-foreground dark:fill-white" />
                      <div className="relative h-2 w-[0.71px] rounded-full bg-[#2B2B2B]" />
                      <div className="flex items-center justify-start gap-2">
                        <ChevronLeft className="relative h-3 w-3 overflow-hidden fill-muted-foreground dark:fill-white" />
                        <ChevronRight className="relative h-3 w-3 overflow-hidden fill-muted-foreground dark:fill-white" />
                      </div>
                    </div>
                    <div className="flex items-center justify-start gap-2">
                    ...
                    <div className="flex flex-col items-start justify-start gap-4 self-stretch">
                      <div className="flex flex-col items-start justify-start gap-2.5 self-stretch">
                        ...
                        <div className="inline-flex items-start justify-start gap-1 self-stretch">
                          <Calendar className="relative bottom-[1px] h-2.5 w-2.5 overflow-hidden fill-muted-foreground dark:fill-white" />
                ...
                <div className="absolute left-0 top-[121px] inline-flex w-[650px] flex-col items-start justify-start gap-4 overflow-hidden rounded-3xl border border-[#8B5CF6] bg-[#2A1D48] p-6 outline outline-[#3F325F]">
                  <div className="inline-flex items-center justify-start gap-1.5">
                    ...
                    <div className="flex items-center justify-start gap-1 text-xs leading-3 text-[#948CA4]">
                      AI Summary
                      <ChevronDown className="relative h-2 w-2 overflow-hidden fill-muted-foreground dark:fill-white" />
                    </div>
                  </div>
            ...
            <div className="relative h-96 w-96 overflow-hidden rounded-2xl">
              ...
              <div className="bg-card absolute left-[34px] top-[34px] inline-flex w-[600px] flex-col items-start justify-start overflow-hidden rounded-xl">
                <div className="bg-tokens-surface-secondary border-tokens-stroke-light/5 inline-flex h-12 items-center justify-center gap-3 self-stretch overflow-hidden border-b-[0.50px] px-4 py-3">
                  <div className="flex h-6 items-center justify-center overflow-hidden rounded bg-muted pl-1 pr-1.5">
                    <X className="relative h-3.5 w-3.5 overflow-hidden fill-muted-foreground dark:fill-white" />
                ...
                <div className="bg-tokens-surface-secondary border-tokens-stroke-light/5 flex flex-col items-start justify-start self-stretch overflow-hidden border-b-[0.50px]">
                  ...
                  <div className="flex flex-col items-start justify-start gap-2 self-stretch p-2">
                    ...
                    <div className="inline-flex items-center justify-start gap-3 self-stretch rounded-[10px] bg-card p-3">
                      <img
              ...
              <div className="absolute left-0 top-[319px] mx-auto inline-flex w-full max-w-[894px] flex-col items-start justify-start overflow-hidden rounded-xl bg-zinc-900 opacity-30">
                ...
                <div className="flex flex-col items-start justify-start gap-2 self-stretch px-2 pb-2">
                  ...
                  <div className="inline-flex items-center justify-start gap-3 self-stretch rounded-[10px] p-3">
                    <div className="inline-flex h-8 w-8 flex-col items-center justify-center gap-2.5 overflow-hidden rounded-full bg-muted px-1.5 py-2.5 shadow-[0px_0px_0px_0.5px_rgba(255,255,255,0.00)] shadow-[0px_1px_2px_0px_rgba(255,255,255,0.00)]">
                      <GroupPeople className="h-5 w-5 overflow-hidden fill-muted-foreground dark:fill-white" />
                    </div>
                    <div className="inline-flex flex-1 flex-col items-start justify-start gap-2.5">
                      <div className="inline-flex items-start justify-start gap-2.5 self-stretch">
                        <div className="flex flex-1 items-center justify-start gap-3">
                ...
                <div className="border-tokens-stroke-light/5 inline-flex items-center justify-start gap-2 self-stretch overflow-hidden border-b-[0.50px] py-3.5 pl-5 pr-3.5">
                  <div className="flex flex-1 items-center justify-start gap-3">
                    <div className="text-base-gray-950 flex flex-1 items-center justify-start text-sm leading-none">
                      <X className="mr-2 h-4 w-4 fill-muted-foreground dark:fill-white" />
                      New chat
                    </div>
                  </div>
                  <div className="flex h-6 items-center justify-center gap-0.5 overflow-hidden rounded-md px-1">
                    <Plus className="h-3 w-3 overflow-hidden fill-muted-foreground dark:fill-white" />
                  </div>
                  <div className="flex h-6 items-center justify-center gap-0.5 overflow-hidden rounded-md px-1">
                    <PanelLeftOpen className="h-3 w-3 overflow-hidden fill-muted-foreground dark:fill-white" />
                  </div>
                  <div className="flex h-6 items-center justify-center gap-0.5 overflow-hidden rounded-md px-1">
                    <Expand className="h-2.5 w-2.5 overflow-hidden fill-muted-foreground dark:fill-white" />
                  </div>
                </div>
                <div className="relative flex flex-1 flex-col items-center justify-center gap-8 self-stretch overflow-hidden px-5 py-4">
                  ...
                  <div className="absolute left-0 top-[384px] inline-flex w-96 items-center justify-start gap-4 overflow-hidden p-4">
                    <div className="flex h-8 flex-1 items-center justify-start gap-1.5 overflow-hidden rounded-md bg-[#141414] pl-2.5 pr-1">
                      ...
                      <div className="flex h-6 items-center justify-center gap-2.5 rounded bg-muted px-1">
                        <CurvedArrow className="relative left-[1px] mt-1 h-4 w-4 fill-foreground" />
                      </div>
                    </div>
                  </div>
                </div>
