        ...
        {state === 'collapsed' ? (
          ...
          <div className="flex w-full items-center justify-between">
            <div className="flex items-center gap-2">
              {data && activeAccount ? (
                ...
                >
                  <div className="relative">
                    ...
                    {activeAccount.id === activeConnection?.id && data.connections.length > 1 && (
                      <CircleCheck className="fill-mainBlue absolute -bottom-2 -right-2 size-4 rounded-full bg-white dark:bg-card" />
                    )}
                  </div>
                </div>
              ) : (
              ...
              {isPro ? (
                <AddConnectionDialog>
                  <button className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-[5px] border border-dashed dark:bg-muted dark:text-muted-foreground">
                ...
                <>
                  <Button
                    ...
                    className="hover:bg-muted/80 flex h-7 w-7 cursor-pointer items-center justify-center rounded-[5px] border border-dashed bg-transparent px-0 text-black dark:bg-muted dark:text-muted-foreground"
                  >
                    <Plus className="size-4" />
                  </Button>
                </>
