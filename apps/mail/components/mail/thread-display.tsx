...
export function ThreadDemo({ messages, isMobile }: ThreadDisplayProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'bg-muted dark:bg-accent relative flex flex-col overflow-hidden transition-all duration-300',
    ...
    <TooltipProvider delayDuration={0}>
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            <Icon ref={iconRef} className="dark:fill-current fill-current" />
...
export function ThreadDisplay() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'bg-card dark:bg-card relative flex flex-col overflow-hidden rounded-xl transition-all duration-300',
          isMobile ? 'h-full' : 'h-full',
          !isMobile && !isFullscreen && 'rounded-r-lg',
          isFullscreen ? 'fixed inset-0 z-50' : '',
        )}
      >
        {!id ? (
              ...
              <div className="mt-5">
                ...
                <div className="mt-4 grid grid-cols-1 gap-2 xl:grid-cols-2">
                  <button
                    ...
                    className="inline-flex h-7 items-center justify-center gap-0.5 overflow-hidden rounded-lg border bg-white px-2 dark:border-none dark:bg-muted"
                  >
                    <Sparkles className="mr-1 h-3.5 w-3.5 fill-muted-foreground dark:fill-white" />
                  ...
                  <button
                    ...
                    className="inline-flex h-7 items-center justify-center gap-0.5 overflow-hidden rounded-lg border bg-white px-2 dark:border-none dark:bg-muted"
                  >
                    <Mail className="mr-1 h-3.5 w-3.5 fill-muted-foreground dark:fill-white" />
                    <div className="flex items-center justify-center gap-2.5 px-0.5">
          ...
          <>
            <div
              className={cn(
                'flex flex-shrink-0 items-center border-b border px-1 pb-1 md:px-3 md:pb-[11px] md:pt-[12px] dark:border',
                isMobile && 'bg-card dark:bg-card sticky top-0 z-10 mt-2',
              )}
            >
              <div className="flex flex-1 items-center gap-2">
                <TooltipProvider delayDuration={0}>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        onClick={handleClose}
                        className="inline-flex h-7 w-7 items-center justify-center gap-1 overflow-hidden rounded-md hover:bg-white md:hidden dark:hover:bg-muted"
                      >
                        <X className="fill-current dark:fill-current h-3.5 w-3.5" />
                      </button>
                    </TooltipTrigger>
                ...
                <div className="dark:bg-muted/20 relative h-3 w-0.5 rounded-full bg-[#E7E7E7]" />{' '}
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className="inline-flex h-7 w-7 items-center justify-center gap-1 overflow-hidden rounded-md hover:bg-white md:hidden dark:hover:bg-muted"
                        >
                          <ChevronLeft className="fill-current dark:fill-current h-3.5 w-3.5" />
                        </button>
                      </TooltipTrigger>
                      <TooltipContent side="bottom" className="bg-white dark:bg-muted">
                        Previous email
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className="inline-flex h-7 w-7 items-center justify-center gap-1 overflow-hidden rounded-md hover:bg-white md:hidden dark:hover:bg-muted"
                        >
                          <ChevronRight className="fill-current dark:fill-current h-3.5 w-3.5" />
                        </button>
                      </TooltipTrigger>
                      <TooltipContent side="bottom" className="bg-white dark:bg-muted">
                        Next email
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <Reply className="fill-muted-foreground dark:fill-white" />
                  <div className="flex items-center justify-center gap-2.5 pl-0.5 pr-1">
                    <div className="justify-start text-sm leading-none text-foreground">
                      Reply
                    </div>
                  </div>
                </button>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className="inline-flex h-7 w-7 items-center justify-center gap-1 overflow-hidden rounded-md bg-white dark:bg-muted"
                      >
                        <Star
                          className={cn(
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className="inline-flex h-7 w-7 items-center justify-center gap-1 overflow-hidden rounded-md bg-white dark:bg-muted"
                      >
                        <Archive className="fill-current dark:fill-current" />
                      </button>
                    </TooltipTrigger>
                    <TooltipContent side="bottom" className="bg-white dark:bg-muted">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="inline-flex h-7 w-7 items-center justify-center gap-1 overflow-hidden rounded-md bg-white focus:outline-none focus:ring-0 dark:bg-muted">
                  ...
                  <DropdownMenuContent align="end" className="bg-white dark:bg-muted">
                    {/* <DropdownMenuItem onClick={() => setIsFullscreen(!isFullscreen)}>
                      <Expand className="fill-current dark:fill-current mr-2" />
                      <span>
                        {isFullscreen
                    ...
                    {isInSpam || isInArchive || isInBin ? (
                      ...
                      <>
                        ...
                        <DropdownMenuItem onClick={() => moveThreadTo('spam')}>
                          <ArchiveX className="fill-current dark:fill-current mr-2" />
                        ...
                        emailData.latest?.listUnsubscribePost ? (
                          <DropdownMenuItem onClick={handleUnsubscribeProcess}>
                            <Folders className="fill-current dark:fill-current mr-2" />
                    ...
                    {!isImportant && (
                      <DropdownMenuItem onClick={handleToggleImportant}>
                        <Lightning className="fill-current dark:fill-current mr-2" />
