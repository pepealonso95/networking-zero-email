  ...
  return (
    <div className="relative flex-1">
      <form className="relative flex items-center" onSubmit={form.handleSubmit(submitSearch)}>
        <Search
          className="absolute left-2.5 top-[10px] z-10 h-3.5 w-3.5 fill-muted-foreground dark:fill-white"
          aria-hidden="true"
        />
        ...
        <div className="relative w-full">
          <Input
            placeholder={'Search'}
            className="text-muted-foreground placeholder:text-muted-foreground/70 h-[32px] w-full select-none rounded-md border bg-white pl-8 pr-14 shadow-none ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 dark:border-none dark:bg-card"
            {...form.register('q')}
            value={q}
