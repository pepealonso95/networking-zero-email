                  ...
                  {labels?.map((label) => {
                    return (
                      ...
                      >
                        ...
                        <div className="dark:bg-card absolute right-2 z-[25] flex items-center gap-1 rounded-xl border bg-white p-1 opacity-0 shadow-sm transition-opacity group-hover:opacity-100">
                          <Tooltip>
                            ...
                            <TooltipContent className="dark:bg-card mb-1 bg-white">
                              Edit Label
                            </TooltipContent>
                          </Tooltip>
                          <Tooltip>
