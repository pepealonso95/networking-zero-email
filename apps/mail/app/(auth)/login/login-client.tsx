            ...
            <div className="rounded-lg border border-black/10 bg-black/5 p-5 dark:border-white/10 dark:bg-white/5">
              <div className="flex flex-col space-y-4">
                <div className="flex items-center">
                  ...
                  <h3 className="ml-2 text-base font-medium text-foreground">
                ...
                <a
                  ...
                  className="inline-flex items-center text-sm text-black/60 underline underline-offset-2 hover:text-foreground/60 dark:hover:text-white"
                >
